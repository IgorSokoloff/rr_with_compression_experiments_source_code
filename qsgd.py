...
def estimator (X_ar, x, y_ar, la, n_w, batch_ar, k_rk, rs_randk, rs_sgd, randk_probs):
...
def run_algorithm(x_0, x_star, f_star, X_ar, y_ar, la, stepsize, batch_ar, eps, k_rk, n_w, experiment_name, project_path, dataset, n_epochs):
...
experiment_name = "qsgd-wr_nw{0}_b{1}_{2}x".format(n_w, myrepr(prb), myrepr(factor))
print ('------------------------------------------------------------------------------------------------')
start_time = time.time()
run_algorithm(x_0, x_star, f_star, X_ar, y_ar, la, step_size, batch_ar, eps,  k_rk, n_w, experiment_name, project_path, dataset, n_epochs)
